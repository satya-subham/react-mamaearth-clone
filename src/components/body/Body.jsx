...
export default function Body({ interval = 3000 }) {
  ...
  useEffect(() => {
    axios
      .get("https://mamarath-backend.vercel.app/api/v1/body")
      .then((response) => {
  ...
  const [buttons, setButtons] = useState(['ALL', 'BODY LOTION', 'BODY WASH', 'SOAP', 'BODY SCRUB']);
