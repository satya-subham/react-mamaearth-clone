          ...
          <div className="footer-bowl">
            <div id="first-col">
              ...
              <div className="contactus-bowl">
                ...
                <NavLink to="">
                  <button id="contact-btn" className="mb-1">
                    CONTACT US
                  </button>
                </NavLink>
              </div>
            ...
            <div className="imp-link">
              <div className="useful-bowl">
                ...
                <ul>
                  ...
                  <li className="link-foot">
                    <NavLink to="">Terms&Conditions-Cashback</NavLink>
                  </li>
                  <li className="link-foot">
                    <NavLink to="">FAQs</NavLink>
                  </li>
                  <li className="link-foot">
                    <NavLink to="">We're Safe</NavLink>
                  </li>
                  <li className="link-foot">
            ...
            <div className="end">
              <h3 className="last-line">
                <span className="c">ⓒ</span> 2025 Satyasubham@The Skillians .
                All Rights Reserved
              </h3>
            </div>
          </div>
